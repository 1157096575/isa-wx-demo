...
// 初始化recycleData By Neo Li @2019-11-22
RecycleContext.prototype.reset = function () {
  delete recycleData.recycleId
  delete recycleData.oldData
}
...
RecycleContext.prototype.updateList = function (beginIndex, list, cb) {
  ...
  // isa 2021.9.18 start
  const len = recycleData[id].list ? recycleData[id].list.length : 0
  if(len && list){
